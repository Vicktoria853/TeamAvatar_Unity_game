...
public class Player : MonoBehaviour
{
    ...
    private void FixedUpdate(){
        ...
        hit = Physics2D.BoxCast(transform.position, Player_hitbox.size, 0, new Vector3(0, Player_vector.y), Mathf.Abs(Player_vector.y * Time.deltaTime), LayerMask.GetMask("People"));
